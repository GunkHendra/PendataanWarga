<nav class="w-72 bg-gradient-to-t from-emerald-300 via-emerald-600 to-emerald-800 h-full text-white flex flex-col sticky top-0">
    ...
    <nav class="mt-4 basis-3/5 flex flex-col justify-between px-4">
        <div>
            ...
            <a href="/admin/data_warga" class="{{ ($title === 'Data Warga Pendatang' || $title === 'Pendataan Warga') ? 'bg-emerald-900 rounded-lg' : 'hover:bg-emerald-700 rounded-lg' }} flex flex-row py-2 px-2 gap-2 items-center mb-2"><span><img class="w-12 h-12" src="/assets/dashboard-icon/notepad.png" alt="Home Icon"></span>Data Warga</a>
